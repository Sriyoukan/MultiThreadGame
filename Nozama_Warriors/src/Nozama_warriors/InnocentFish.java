...
/**
 * warrior want to move, after he meet the innocent fish
        ...
        while (Grid.notreached) {
            ...
            if (oldx >= 5 && oldy >= 5) {                                                                               // Checking the warriors node
                ...
                if (randomno == 0) {
                    ...
                    if ((oldx - 1) > -1) {                                                                              //(x-1,y)
                        if (!(lake.allowSwim(warrior, oldx, oldy, oldx - 1, oldy))) {                              // tell Grid that he is swming
                    ...
                    if ((oldy - 1) > -1) {                                                                              //(x,y-1)
                        if (!lake.allowSwim(warrior, oldx, oldy, oldx, oldy - 1)) {
                            break;
                        }
                    }
                }
                ...
                if (randomno == 0) {
                    /* In random increasing  X-1*/
                    if ((oldx - 1) > -1) {                                                                              //(x-1,y)
                        if (!lake.allowSwim(warrior, oldx, oldy, oldx - 1, oldy)) {
                            break;
                        }
                    }
                } else if (randomno == 1) {
